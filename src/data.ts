...
export const defaultState: AppState = {
  ...
  advice: [
    "Не пий кафе или чай на празен стомах.",
    "Храни се редовно и не пропускай закуска.",
    "Започвай деня си всяка сутрин с 200 мл. топла/хладка вода.",
    "Времето между храненията е около 4 часа.",
    "Грамажите на протеините са дадени в готов вид.",
    "Грамажите на въглехидратите са в суров вид. Винаги.",
    "Задължително използвай кухненска везна поне в началото.",
    "Месата приготвяй на фурна, скара, грил тиган или на пара.",
    "Овкусявай салатите с 1 с.л. зехтин, лимон/ябълков оцет и малко сол.",
  ],
  diningOut:
    "Когато се храниш навън, избирай чист протеин, свежи салати без сосове, задушени или грил зеленчуци, ориз/елда/киноа и искай дресинга отделно.",
  macros: [
    {
      id: "macro-carbs",
      title: "Въглехидрати",
